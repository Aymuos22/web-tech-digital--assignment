            ...
            <div className={styles.inner_container}>
                <div className={styles.contact}>
                    <div className={styles.info}>
                        ...
                        <p>Call us at <a className={styles.link} href="tel:+123456789">6371688200</a></p>
                    ...
                    <div className={styles.info}>
                        ...
                        <p>Email us at <a className={styles.link} href="mailto:info@pizzashop.com">test@test.com</a></p>
                    </div>
                    <hr className={styles.hr}/>
                    <div className={styles.info}>
                        <div className={styles.icon}>
